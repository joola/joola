...
setInterval(function() { run('dummy:counter')}, getInterval());
setInterval(function() { run('dummy2:counter')}, getInterval());
setInterval(function() { run('dummy3:counter')}, getInterval());
setInterval(function() { run('dummy4:counter')}, getInterval());
