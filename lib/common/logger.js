...
var consoleLevel = joola.config.get('store:logger:console:level') || (process.env.NODE_ENV === 'test' ? 'trace' : null) || process.env.JOOLA_CONFIG_STORE_LOGGER_CONSOLE_LEVEL || 'debug';
...
var logglyToken = process.env.JOOLA_CONFIG_STORE_LOGGER_LOGGLY_TOKEN;
var logglyDomain = process.env.JOOLA_CONFIG_STORE_LOGGER_LOGGLY_DOMAIN;
var logglyLevel = process.env.JOOLA_CONFIG_STORE_LOGGER_LOGGLY_LEVEL || 'info';
