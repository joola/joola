...
var consoleLevel = joola.config.get('store:logger:console:level') || (process.env.NODE_ENV === 'test' ? 'trace' : null) || process.env.JOOLA_CONFIG_STORE_LOGGER_CONSOLE_LEVEL || 'info';
