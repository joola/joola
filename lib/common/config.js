...
config.onchange = function (event) {
  joola.logger.info('Configuration change detected via zookeeper.');
...
config.clear = function (key, callback) {
  ...
  config.zookeeper.setData('/JOOLA', new Buffer(JSON.stringify(config._config)), config.onchange, function (err, stat) {
