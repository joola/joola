                ...
                joola.config.get('authentication:organizations:' + org + ':users', function (err, values) {
                  if (values) {
                    Object.keys(values).forEach(function (user) {
                      ...
                      console.log('user', user._password ,rawConfig.authentication.organizations[org].users[user.username]._password)
                      if (user._password == rawConfig.authentication.organizations[org].users[user.username]._password) {
