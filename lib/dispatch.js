...
Dispatch.prototype.emitWait = function (namespace, message, details, callback) {
  var self = this;
...
Dispatch.prototype.emit = function (namespace, message, details, callback) {
  var self = this;
  var channel = namespace + ':' + message;
...
Dispatch.prototype.on = function (namespace, message, callback) {
  var self = this;
  var channel = namespace + ':' + message;
...
Dispatch.prototype.once = function (namespace, message, callback) {
  var channel = namespace + ':' + message;
