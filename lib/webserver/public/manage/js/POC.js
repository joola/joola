...
function POC_setup() {
  ...
  function onMessage(evt) {
    ...
    joolaio.dispatch.beacon.insert('blockchain', {timestamp: new Date(data.time * 1000), hash: data.hash, inamount: inamount, outamount: outamount, delta: delta});
