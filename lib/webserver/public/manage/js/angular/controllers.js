...
joolaControllers.controller('userCtrl', function ($scope, userService) {
  ...
  $scope.userEdit = function (username) {
    userService.get(username, function (err, res) {
      ...
      $('#editUserDialog #username').val(res.username);

      $('#editUserDialog #displayname').val(res.displayName);
      $('#editUserDialog #roles').val(res._roles);
      $('#editUserDialog #permissions').val(res._filter);
      $('#editUserDialog #organization').val(res.organization);
      $('#editUserDialog #store').val(res.store);
