...
exports.route = function (req, res) {
  ...
  d.run(function () {
    ...
    if (!req.token && modulename != 'test' && modulename != 'users')
      return exports.responseError(500, new ErrorTemplate('Missing token.'), req, res);
    ...
    if (['png', 'ico', 'gif', 'css'].indexOf(req.url.substring(req.url.length - 3)) > -1)
      return exports.responseError(500, new ErrorTemplate('Not implemented.'), req, res);

    _.extend(req.params, req.query);

    if (!modulename)
      return exports.responseError(500, new ErrorTemplate('Module not specified.'), req, res);
    ...
    try {
      ...
      return exports.responseError(500, ex, req, res);
    }
    ...
    var dispatchRoute = function (req, res) {
      ...
      setImmediate(function () {
        ...
        timerID = setTimeout(function () {
          return exports.responseError(500, new exports.ErrorTemplate('Timeout while waiting for [' + action.name + ']'), req, res);
