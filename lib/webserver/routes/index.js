...
exports.setup = function (app) {
  ...
  app.post('/tokens/:workspace', middleware('/users/generateToken'), exports.router);
  app.get('/tokens/:workspace/:token', middleware('/users/validateToken'), exports.router);
  app.delete('/tokens/:workspace/:token', middleware('/users/expireToken'), exports.router);
  ...
  app.put('/collections/:workspace/:key', middleware);
