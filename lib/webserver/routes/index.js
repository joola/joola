...
exports.setup = function (app) {
  ...
  app.get('/system/usage', middleware('/system/usage'), exports.router);
  app.get('/system/usage/:workspace', middleware('/system/usage'), exports.router);
  app.get('/system/usage/:workspace/:username', middleware('/system/usage'), exports.router);
  app.get('/system/usage/:workspace/:username/:collection', middleware('/system/usage'), exports.router);
