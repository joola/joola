...
exports.sdk = function (min, _req, _res) {
  ...
  if (sdkConfig && sdkConfig.url && sdkConfig.url !== '') {
    ...
    var filename;
    if (min === true)
      filename = path.join(__dirname, '../../../node_modules/joola.io.sdk/build/release/', 'joola.io.min.js');
    else {
      if (min) {
        _res = _req;
        _req = min;
      ...
      filename = path.join(__dirname, '../../../node_modules/joola.io.sdk/build/release/', 'joola.io.js');
    }
...
exports.sdk_map = function (min, _req, _res) {
  var filename = path.join(__dirname, '../../../node_modules/joola.io.sdk/build/release/', 'joola.io.min.js.map');

  fs.readFile(filename, function read(err, data) {
    /* istanbul ignore if */
    if (err) {
      joola.logger.warn(_req, 'Error while loading SDK source map from disk: ' + err);
      return _res.send('Failed to load file: ' + err);
    }
...
exports.css = function (req, res) {
  var filename = path.join(__dirname, '../../../node_modules/joola.io.sdk/build/release/', 'joola.io.css');
  fs.readFile(filename, function read(err, data) {
    /* istanbul ignore if */
    if (err) {
...
exports.setup = function (app) {
  ...
  app.get('/joola.io.min.js.map', function (req, res) {
    return exports.sdk_map(true, req, res);
  });
