...
exports.get = {
	...
	dispatch: function () {
		var self = this;
		joola.dispatch.on('datasources:get-request', function (channel, name) {
	...
	route: function (req, res) {
		joola.dispatch.emitWait('datasources:get-request', req.params.name, function (err, datasource) {
			if (err)
