...
exports.stop = {
  ...
  _route: function (req, res) {
    ...
    if (manager.realtimeQueries[querytoken]) {
      console.log('found realtime query', querytoken, manager.realtimeQueries[querytoken]);
      var sid = res.socket.id;
      console.log('socket for query', sid, manager.realtimeQueries[querytoken].sockets[sid]);
        ...
        if (exist) {
          ...
          var realtime = function () {
            request(false, function (err, result) {
              ...
              var sockets = manager.realtimeQueries[queryKey].sockets;
