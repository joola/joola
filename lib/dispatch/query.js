...
manager.formatResults = function(results, callback) {
  ...
  var documentProcessing = function(n) {
    var document = results.documents[n];
  ...
  var postProcessing = function(err, results) {
    var _metrics = [];
  ...
  lupus(0, results.documents.length, documentProcessing, postProcessing);
};
