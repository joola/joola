...
manager.translateTimeframe = function (timeframe, interval) {
  ...
  switch (interval) {
    case 'second':
      ...
      break;
    case 'minute':
      _startdate.setMinutes(_startdate.getMinutes() + 1);
      break;
    case 'hour':
  ...
  switch (timeframe) {
    ...
    case 'last_5_seconds':
      _startdate.setSeconds(_startdate.getSeconds() - 5);
      return {
        start: new Date(_startdate),
        end: new Date(_enddate)
      };
    case 'last_30_seconds':
      _startdate.setSeconds(_startdate.getSeconds() - 30);
      return {
        start: new Date(_startdate),
        end: new Date(_enddate)
      };
    ...
    case 'last_5_minutes':
      _startdate.setMinutes(_startdate.getMinutes() - 5);
      return {
        start: new Date(_startdate),
        end: new Date(_enddate)
      };
    case 'last_10_minutes':
      _startdate.setMinutes(_startdate.getMinutes() - 10);
      return {
        start: new Date(_startdate),
        end: new Date(_enddate)
      };
    case 'last_30_minutes':
      _startdate.setMinutes(_startdate.getMinutes() - 30);
      return {
        start: new Date(_startdate),
        end: new Date(_enddate)
      };
