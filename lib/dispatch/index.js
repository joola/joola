...
var dispatch = module.exports = function () {
  var self = dispatch;

  self.namespace = 'dispatch';
  self.host = joola.config.stores.dispatch.redis.host || 'localhost';
  self.port = joola.config.stores.dispatch.redis.port || 6379;
  self.db = joola.config.stores.dispatch.redis.db || 0;
