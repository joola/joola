...
exports.list = {
  ...
  run: function (context, callback) {
    ...
    joola.config.get('authentication:organizations:' + context.user.organization + ':collections', function (err, value) {
      if (err) {
        return callback(err);
      }
...
exports.get = {
  ...
  run: function (context, id, callback) {
    callback = callback || emptyfunc;
    joola.config.get('authentication:organizations:' + context.user.organization + ':collections:' + id, function (err, value) {
      if (err)
        return callback(err);
...
exports.add = {
  ...
  run: function (context, collection, callback) {
    ...
    joola.config.get('authentication:organizations:' + context.user.organization + ':collections', function (err, value) {
      ...
      joola.config.set('authentication:organizations:' + context.user.organization + ':collections', _collections, function (err) {
        if (err)
          return callback(err);
...
exports.update = {
  ...
  run: function (context, collection, callback) {
    ...
    exports.get.run(context, collection.id, function (err) {
      if (err)
        return callback(err);
...
exports.delete = {
  ...
  run: function (context, id, callback) {
    ...
    exports.get.run(context, id, function (err, value) {
      ...
      joola.config.clear('authentication:organizations:' + context.user.organization + ':collections:' + id, function (err) {
        if (err)
          return callback(err);
...
exports.maxdate = {
  ...
  run: function (context, id, key, callback) {
    ...
    exports.get.run(context, id, function (err, value) {
      ...
      joola.mongo.find('cache', context.user.organization + '_' + id, {}, {limit: 1, sort: sortKey}, function (err, result) {
        if (err)
          return callback(err);
...
exports.metadata = {
  ...
  run: function (context, document, collection, callback) {
    callback = callback || emptyfunc;
    var _shadow = {};
    ...
    if (collection) {
      exports.get.run(context, collection, function (err, _collection) {
        if (err)
          return callback(err);
