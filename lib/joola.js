...
joola.init = function (options, callback) {
  ...
  joola.config.init(function (err) {
    /* istanbul ignore if */
    if (err) {
      console.log('Error starting application. This error occurred while trying to initalize the framework.');
    ...
    joola.dispatch.init(function (err) {
      /* istanbul ignore if */
      if (err) {
        console.log('Error starting application. This error occurred while trying to initalize the dispatch sub-system.');
      ...
      joola.datastore.init(function (err) {
        /* istanbul ignore if */
        if (err) {
          console.log('Error starting application. This error occurred while trying to initalize the datastore sub-system.');
          console.log('Exception details:');
          console.log(err);
          process.exit();
        }
        ...
        joola.webserver.start({webserver_app: joola.options.webserver_app}, function (err, http) {
          /* istanbul ignore if */
          if (err) {
