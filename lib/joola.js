...
joola.init = function (options, callback) {
  ...
  joola.config.init(function (err) {
    ...
    if (!joola.redis && redisConfig && redisConfig.enabled === true)
  ...
  setInterval(function () {
    joola.logger.debug('EPS: ' + joola.statistics.eps + ', Max: ' + joola.statistics.max_eps + ', Total: ' + joola.statistics.total);
  }, 1000);
};
